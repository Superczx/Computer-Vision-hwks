...
%SSD
% disparityMap_SSD1 = disparity_SSD(frameLeftGray, frameRightGray,1);
% disparityMap_SSD5 = disparity_SSD(frameLeftGray, frameRightGray,5);
% disparityMap_SSD11 = disparity_SSD(frameLeftGray, frameRightGray,11);
%NCC
% disparityMap_NCC3 = disparity_NCC(frameLeftGray, frameRightGray,3);
% disparityMap_NCC5 = disparity_NCC(frameLeftGray, frameRightGray,5);
% disparityMap_NCC7 = disparity_NCC(frameLeftGray, frameRightGray,7);
%UC
% disparityMap_UC = disparity_UC(frameLeftGray,frameRightGray,5);
%DP
% frameLeftDP  = double(frameLeftGray)./255;
% frameRightDP = double(frameRightGray)./255;
% [row_max,col_max]=size(frameLeftGray);
% disparityMap_DP=zeros(row_max,col_max);
% for row=1:row_max
%     e1 = frameRightDP(row,:);
%     e2 = frameLeftDP(row,:);
%     D = stereoDP(e1, e2, 63, 0.01);
%     disparityMap_DP(row,:) = D;
%     row
% end
figure;
% subplot(2,2,1);
...
% points3D = reconstructScene(disparityMap_DP, stereoParams);
points3D = depth(disparityMap, stereoParams);
